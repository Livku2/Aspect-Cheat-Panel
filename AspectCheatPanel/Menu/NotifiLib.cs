...
namespace Aspect.MenuLib
{
    ...
    public class NotifiLib : BaseUnityPlugin
    {
        ...
        static int NotificationDecayTime = 120;
        static int NotificationDecayTimeCounter = 0;
        public static int NoticationThreshold = 6; //Amount of notifications before they stop queuing up
        ...
        private static void FixedUpdate()
        {
            ...
            if (!IsEnabled && NotifiText.text != "") ClearAllNotifications();
        ...
        public static void SendNotification(string NotificationText, bool forced = false)
        {
            if (IsEnabled && Notifications < NoticationThreshold || forced)
            {
                Notifications++;
        ...
        public static bool TurnOffNotifications()
        {
            IsEnabled = !IsEnabled;
            return IsEnabled;
        }
